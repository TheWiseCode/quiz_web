...
INSERT INTO `account_type` (`account_id`, `users`, `quiz`, `results`, `questions`, `account_name`, `setting`,
                            `study_material`, `appointment`)
VALUES (1, 'Add,Edit,View,List,List_all,Myaccount,Remove', 'Attempt,Add,Edit,View,List,List_all,Remove',
        'View,List,List_all,Remove', 'Add,Edit,View,list,List_all,Remove', 'Administrator', 'All',
        'Add,Edit,View,List,List_all,Remove', 'List,List_all'),
...
INSERT INTO `appointment_request` (`appointment_id`, `request_by`, `to_id`, `appointment_timing`,
                                   `appointment_time_zone`, `appointment_status`)
VALUES (2, 9, 1, '2017-08-30 07:53:57', 'Asia/Kolkata', 'Accepted'),
...
INSERT INTO `savsoftquiz_setting` (`setting_id`, `setting_name`, `setting_value`, `setting_group_name`, `order_by`,
                                   `setting_description`)
VALUES (1, 'App_Name', '', 'General', 1, NULL),
...
INSERT INTO `savsoft_add` (`add_id`, `advertisement_code`, `banner`, `banner_link`, `position`, `add_status`)
VALUES (1, '', '1501084226.jpg', 'https://savsoftquiz.com', 'Top', 'Inactive'),
...
INSERT INTO `savsoft_answers` (`aid`, `qid`, `q_option`, `uid`, `score_u`, `rid`, `qn`)
VALUES (8, 79, '300', 1, 1, 1, 0),
       (9, 80, '304', 1, 1, 1, 0),
       (10, 81, '317', 1, 0.5, 1, 0),
       (11, 81, '319', 1, 0.5, 1, 0),
       (15, 81, '317', 1, 0.5, 3, 0),
...
INSERT INTO `savsoft_category` (`cid`, `category_name`)
VALUES (1, 'General knowledge'),
       (2, 'Math');
...
INSERT INTO `savsoft_group` (`gid`, `group_name`, `price`, `valid_for_days`, `description`)
VALUES (1, 'Free', 0, 0, '10 Free quiz'),
...
INSERT INTO `savsoft_level` (`lid`, `level_name`)
VALUES (1, 'Easy'),
       (2, 'Difficult');
...
INSERT INTO `savsoft_notification` (`nid`, `notification_date`, `title`, `message`, `click_action`, `notification_to`,
                                    `response`, `uid`, `viewed`)
VALUES (1, '2019-03-18 06:20:37', 'Developer', 'test', 'http://localhost/savsoftquiz_v5/', '/topics/SavsoftQuiz',
        ...
        0, 0),
       (2, '2019-03-18 12:41:51', 'Developer', 'Helllo', 'http://localhost/savsoftquiz_v5/', '/topics/SavsoftQuiz',
        '<HTML>\n<HEAD>\n<TITLE>Invalid (legacy) Server-key delivered or Sender is not authorized to perform request.</TITLE>\n</HEAD>\n<BODY BGCOLOR=\"#FFFFFF\" TEXT=\"#000000\">\n<H1>Invalid (legacy) Server-key delivered or Sender is not authorized to perform request.</H1>\n<H2>Error 401</H2>\n</BODY>\n</HTML>\n',
        0, 0);
...
INSERT INTO `savsoft_options` (`oid`, `qid`, `q_option`, `q_option_match`, `q_option1`, `score`, `q_option_match1`)
VALUES (46, 6, 'Good Morning', 'Good Night', '', 0.25, ''),
       (47, 6, 'Honda', 'BMW', '', 0.25, ''),
...
INSERT INTO `savsoft_payment` (`pid`, `uid`, `gid`, `quid`, `amount`, `paid_date`, `payment_gateway`, `payment_status`,
                               `transaction_id`, `other_data`)
VALUES (1, 10, 3, 0, 100, 0, 'Paypal', 'Paid', '1233423DCFDFD', NULL);
...
INSERT INTO `savsoft_qbank` (`qid`, `question_type`, `question`, `description`, `question1`, `description1`, `cid`,
                             `lid`, `no_time_served`, `no_time_corrected`, `no_time_incorrected`, `no_time_unattempted`,
                             `inserted_by`, `inserted_by_name`, `paragraph`, `paragraph1`, `parent_id`)
VALUES (79, 'multiple_choice_single_answer', ' what is 2+2 =?', '  description here',
        ' what is 2+2 =? &ndash; This is second language question Note &ndash; keep question number same as its primary language question',
        '  description here', 1, 1, 55, 16, 15, 24, 0, NULL, NULL, NULL, 0),
       (80, 'multiple_choice_single_answer',
        ' what is 2+2 =? &ndash; This is second language question Note &ndash; keep question number same as its primary language question',
        '  description here', NULL, NULL, 1, 1, 21, 2, 10, 9, 0, NULL, NULL, NULL, 0),
       (81, 'multiple_choice_multiple_answer', ' what is 2+6 =?', '  ', NULL, NULL, 2, 1, 48, 13, 19, 16, 0, NULL, NULL,
        NULL, 0),
       (82, 'multiple_choice_single_answer',
        ' Who is in the picture?<img src=&#34;http://localhost/savsoftquiz_v4.0_enterprise/upload/word_images/15090303561.jpeg&#34;>',
        '  ', NULL, NULL, 1, 1, 0, 0, 0, 0, 0, NULL, NULL, NULL, 0),
       (111, 'multiple_choice_single_answer', ' what is 2+2 =?', '  description here',
        ' what is 2+2 =? &ndash; This is second language question Note &ndash; keep question number same as its primary language question',
        '  description here', 2, 1, 0, 0, 0, 0, 0, NULL, '', NULL, 0),
       (112, 'multiple_choice_single_answer',
        ' what is 2+2 =? &ndash; This is second language question Note &ndash; keep question number same as its primary language question',
        '  description here', NULL, NULL, 2, 1, 0, 0, 0, 0, 0, NULL, '', NULL, 0),
       (113, 'multiple_choice_multiple_answer', ' what is 2+6 =?', '  ', NULL, NULL, 2, 1, 0, 0, 0, 0, 0, NULL, '',
        NULL, 0),
       (114, 'multiple_choice_single_answer',
        ' Who is in the picture?<img src=&#34;http://localhost/savsoftquiz_v4.0_enterprise/upload/word_images/15091000591.jpeg&#34;>',
        '  ', NULL, NULL, 2, 1, 0, 0, 0, 0, 0, NULL, '', NULL, 0),
       (115, 'multiple_choice_single_answer', ' what is 2+2 =?', '  description here',
        ' what is 2+2 =? &ndash; This is second language question Note &ndash; keep question number same as its primary language question',
        '  description here', 2, 1, 2, 0, 1, 1, 0, NULL, ' Paragraph here', ' Paragraph here', 0),
       (116, 'multiple_choice_single_answer',
        ' what is 2+2 =? &ndash; This is second language question Note &ndash; keep question number same as its primary language question',
        '  description here', NULL, NULL, 2, 1, 0, 0, 0, 0, 0, NULL, ' Paragraph here', NULL, 0),
       (117, 'multiple_choice_multiple_answer', ' what is 2+6 =?', '  ', NULL, NULL, 2, 1, 2, 0, 0, 2, 0, NULL, '',
        NULL, 0),
       (118, 'multiple_choice_single_answer',
        '<p>Who is in the picture?<img src=\"../../../../savsoftquiz_v4.0_enterprise/upload/word_images/15091002001.jpeg\" /></p>',
        '', NULL, NULL, 2, 1, 2, 0, 0, 2, 0, NULL, NULL, NULL, 0);
...
INSERT INTO `savsoft_qcl` (`qcl_id`, `quid`, `cid`, `lid`, `noq`, `i_correct`, `i_incorrect`)
VALUES (80, 2, 1, 1, 3, '1', '0'),
       (81, 2, 0, 1, 1, '1', '0'),
       (82, 2, 2, 1, 1, '1', '0');
...
INSERT INTO `savsoft_quiz` (`quid`, `quiz_name`, `description`, `start_date`, `end_date`, `gids`, `qids`, `noq`,
                            `correct_score`, `incorrect_score`, `ip_address`, `duration`, `maximum_attempts`,
                            `pass_percentage`, `view_answer`, `camera_req`, `question_selection`, `gen_certificate`,
                            `certificate_text`, `with_login`, `quiz_template`, `uids`, `inserted_by`,
                            `inserted_by_name`, `show_chart_rank`, `quiz_price`)
VALUES (6, '1BPS', '<p>Description here</p>', 1509030367, 1572102367, '1', '81,79', 2, '1,1', '0,0', '', 100, 100, 50,
        1, 0, 0, 0, NULL, 1, 'IN', NULL, 1, 'Admin Admin', 1, 0),
       (7, 'Quiz - Paid', '', 1511412289, 1574484289, '1', '115,117,118', 3, '1,1,1', '0,0,0', '', 10, 10, 50, 1, 0, 0,
        0, NULL, 1, 'Default', NULL, 1, 'Admin Admin', 1, 10),
       (8, 'Default Quiz', '', 1511412326, 1606106726, '1,3', '79,80,81', 3, '1,1,1', '-1,-1,-0.5', '', 10, 10, 50, 1,
        0, 0, 0, NULL, 0, 'Default', NULL, 1, 'Admin Admin', 1, 0),
       (9, 'Quiz 23 March 2018', '', 1555490864, 1556009264, '1', '117,116,115,114', 4, '1,1,1,1', '0,0,0,0', '', 10,
        10, 50, 1, 0, 0, 0, NULL, 1, 'Default', NULL, 1, 'Admin Admin', 1, 0);
...
INSERT INTO `savsoft_result` (`rid`, `quid`, `uid`, `result_status`, `start_time`, `end_time`, `categories`,
                              `category_range`, `r_qids`, `individual_time`, `total_time`, `score_obtained`,
                              `percentage_obtained`, `attempted_ip`, `score_individual`, `photo`, `manual_valuation`)
VALUES (1, 8, 1, 'pass', 1511412687, 1511412701, 'General knowledge,Math', '2,1', '79,80,81', '0,6,0', 6, 3, 100, '::1',
        '1,1,1', '', 0),
       (2, 6, 1, 'fail', 1511413331, 1511413340, 'Math,General knowledge', '1,1', '81,79', '5,0', 5, 0, 0, '::1', '0,0',
        '', 0),
       (3, 6, 1, 'fail', 1511413356, 1511413383, 'Math,General knowledge', '1,1', '81,79', '0,5', 5, 0, 0, '::1', '2,2',
        '', 0),
       (4, 8, 1, 'pass', 1513919539, 1513919552, 'General knowledge,Math', '2,1', '79,80,81', '0,4,0', 4, 3, 100, '::1',
        '1,1,1', '', 0),
       (5, 8, 1, 'fail', 1514276635, 1514276648, 'General knowledge,Math', '2,1', '79,80,81', '0,5,4', 9, 0.5, 5.55556,
        '::1', '1,2,2', '', 0),
       (6, 8, 1, 'fail', 1514276724, 1514276735, 'General knowledge,Math', '2,1', '79,80,81', '0,5,3', 8, -0.5,
        -5.55556, '::1', '1,2,2', '', 0),
       (7, 8, 1, 'fail', 1552662063, 1552662225, 'General knowledge,Math', '2,1', '79,80,81', '89,7,0', 96, -2.5,
        -83.3333, '::1', '2,2,2', '', 0),
       (8, 8, 1, 'fail', 1552669931, 1552669944, 'General knowledge,Math', '2,1', '79,80,81', '0,7,2', 9, -0.5,
        -16.6667, '::1', '1,2,2', '', 0),
       (9, 8, 1, 'fail', 1552889514, 1552889691, 'General knowledge,Math', '2,1', '79,80,81', '35,43,53', 131, -0.5,
        -16.6667, '::1', '1,2,2', '', 0),
       (10, 8, 5, 'fail', 1552913410, 1552913423, 'General knowledge,Math', '2,1', '79,80,81', '0,5,0', 5, -2.5,
        -83.3333, '::1', '2,2,2', '', 0),
       (11, 8, 1, 'fail', 1553771627, 1553771665, 'General knowledge,Math', '2,1', '79,80,81', '0,0,0', 0, -1, -33.3333,
        '::1', '2,0,0', '', 0),
       (12, 8, 1, 'fail', 1553771675, 1553771682, 'General knowledge,Math', '2,1', '79,80,81', '3,0,0', 3, -1, -33.3333,
        '::1', '2,0,0', '', 0),
       (13, 7, 1, 'fail', 1556044127, 1556044162, 'Math', '3', '115,117,118', '0,30,0', 30, 0, 0, '::1', '2,0,0', '',
        0),
       (14, 6, 1, 'fail', 1556044200, 1556044253, 'Math,General knowledge', '1,1', '81,79', '7,41', 48, 0, 0, '::1',
        '2,2', '', 0),
       (15, 6, 1, 'pass', 1557312571, 1557313635, 'Math,General knowledge', '1,1', '81,79', '268,760', 1028, 1, 50,
        '::1', '2,1', '', 0),
       (16, 6, 1, 'pass', 1557313955, 1557314164, 'Math,General knowledge', '1,1', '81,79', '0,205', 205, 1, 50, '::1',
        '1,0', '', 0),
       (17, 8, 13, 'fail', 1558001409, 1558001423, 'General knowledge,Math', '2,1', '79,80,81', '0,6,0', 6, -2,
        -66.6667, '::1', '2,2,0', '', 0),
       (18, 8, 1, 'fail', 1558082971, 1558082983, 'General knowledge,Math', '2,1', '79,80,81', '0,3,0', 3, -2, -66.6667,
        '::1', '2,2,0', '', 0);
...
INSERT INTO `savsoft_users` (`uid`, `password`, `email`, `first_name`, `last_name`, `contact_no`, `connection_key`,
                             `gid`, `su`, `inserted_by`, `subscription_expired`, `verify_code`, `wp_user`,
                             `registered_date`, `photo`, `user_status`, `web_token`, `android_token`, `skype_id`,
                             `time_zone`)
VALUES (1, '21232f297a57a5a743894a0e4a801fc3', 'admin@example.com', 'Admin', 'Admin', '1234567890', NULL, '1', 1, 0,
        1776277800, 0, '', '2017-04-20 11:22:38', NULL, 'Active',
        'dnwIpQWkxyA:APA91bFZLhdxZnPcNareTyHnJRikJGqaT7qh9DF4jSmyKSOq1rv6k7uwgmaQ4_K7jT3WNNUeKRdRQYsNf_OZaQZ7i5nKI_CjA6QGPwPsL5_D7ShPTtsuIwTkr0CuGx0RS7oAVNg_bImc',
        NULL, 'sandhu4222', 'Asia/Kolkata'),
       (5, 'e10adc3949ba59abbe56e057f20f883e', 'user@example.com', 'Userss', 'User', '1234567890', '123', '1', 2, 0,
        2147483647, 0, '', '2017-04-20 11:22:38', NULL, 'Active', NULL, NULL, NULL, 'Asia/Kolkata'),
       (6, '21232f297a57a5a743894a0e4a801fc3', 'subadmin@example.com', 'Subadmin', 'Admin', '1234567890', NULL, '1', 1,
        0, 1818873000, 0, NULL, '2017-08-24 05:50:57', NULL, 'Active', NULL, NULL, NULL, 'Asia/Kolkata'),
       (9, 'e10adc3949ba59abbe56e057f20f883e', 'user2@example.com', 'user2', 'user2', '1234567890', NULL, '1', 2, 0, 0,
        0, NULL, '2017-08-25 10:20:10', NULL, 'Active', NULL, NULL, 'sandhu4222', 'Asia/Kolkata'),
       (10, '202cb962ac59075b964b07152d234b70', 'user23@gmail.com', 'user', 'user', '1234567890', NULL, '1,3', 2, 0, 0,
        0, NULL, '2019-04-24 11:59:24', NULL, 'Active', NULL, NULL, NULL, 'Asia/Kolkata'),
       (11, 'e10adc3949ba59abbe56e057f20f883e', 'user@example222.com', 'sandhu', 'laddi', '1234569870', NULL, '1', 2, 0,
        0, 9545, NULL, '2019-05-14 07:09:48', NULL, 'Active', NULL, NULL, NULL, 'Asia/Kolkata'),
       (12, 'e10adc3949ba59abbe56e057f20f883e', 'contact234@savsoft.info', 'sandhu', 'laddi', '1234567890', NULL, '1',
        2, 0, 0, 6023, NULL, '2019-05-14 07:35:12', NULL, 'Active', NULL, NULL, NULL, 'Asia/Kolkata'),
       (13, '3d1dfde9304bff15332bf4b308a47b50', '1558001408', 'Guest User', '1558001408', '', NULL, '1', 0, 0, 0, 0,
        NULL, '2019-05-16 10:10:08', NULL, 'Active', NULL, NULL, NULL, 'Asia/Kolkata');
...
INSERT INTO `savsoft_users_custom` (`c_id`, `field_id`, `uid`, `field_values`)
VALUES (10, 3, 5, '1234567890'),
       (17, 1, 9, 'DAV'),
       (18, 2, 9, '8529637410'),
       (19, 3, 9, '1234567890');
...
INSERT INTO `social_group` (`sg_id`, `sg_name`, `about`, `sg_status`, `no_member`, `created_date`, `created_by`)
VALUES (1, 'Quiz Star', 'Join masters and compare your ranking', 'Public', 3, '2017-08-27 06:45:45', 1),
...
INSERT INTO `social_group_joined` (`join_id`, `sg_id`, `uid`, `joined_date`)
VALUES (3, 1, 1, '2017-08-27 08:06:39'),
...
INSERT INTO `warning_message` (`wid`, `rid`, `uid`, `warning_time`, `warning_message`)
VALUES (1, 5, 1, 1512452823, 'User idle for more than 2 Minutes'),
