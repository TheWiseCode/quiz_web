...
// Add directory path of your script with respect to file where you are going/added this code
        $dir_paths = getcwd();
        $curl = curl_init();
        curl_setopt_array($curl, array(CURLOPT_RETURNTRANSFER => 1, CURLOPT_URL => 'https://savsoftquiz.com/license/verify_key.php', CURLOPT_USERAGENT => 'Codular Sample cURL Request', CURLOPT_POST => 1,
