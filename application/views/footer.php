...
if ($this->uri->segment(3) != 'ph') {
    ...
    if ($during_quiz != "") {
        ...
        <div style="display:none;width:100%;height:90%;background:transparent;position:fixed;z-index:1800;top:0px;right:0px;padding-top:10%;color:#ffffff;"
             id="advertisement">
            <center>
                <label>Advertisement will close in <?php echo $this->config->item('showadvertisement_sec'); ?>
                    Seconds...</label>
                ...
                if ($this->uri->segment(2) != 'config') {
                    if ($this->uri->segment(2) != 'css') {
                        if ($this->uri->segment(2) != 'edit_advertisment') {
                            ...
                            ?>
                            <script type="text/javascript"
                                    src="<?php echo base_url(); ?>editor/tinymce.min.js"></script>
