                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            if ($this->config->item('allow_switch_group')) {
                                ?>
                                <a hidden href="<?php echo site_url('user/switch_group'); ?>"
                                   class="btn btn-danger"><?php echo $this->lang->line('change_group'); ?></a>
                                <?php
                            }
                            ?>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="skype_id" class="form-control"
                                   value="<?php echo $result['skype_id']; ?>"
                                   placeholder="<?php echo $this->lang->line('skype_id'); ?>" autofocus>
                        </div>
