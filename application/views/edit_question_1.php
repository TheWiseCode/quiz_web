                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <label for="inputEmail"
                                                   class="font-weight-bold"><?php echo $this->lang->line('paragraph') . ' : ' . $val; ?></label>
                        ...
                        foreach ($lang as $lkey => $val) {
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label for="inputEmail"
                                               class="font-weight-bold"><?php echo $this->lang->line('question') . ' : ' . $val; ?></label>
                        ...
                        foreach ($options as $key => $val) {
                            ...
                            <div class="row">
                                ...
                                foreach ($lang as $lkey => $la) {
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <label for="inputEmail" class="font-weight-bold"><?php echo $this->lang->line('options'); ?> <?php echo($key + 1); ?>
                                                ) <?php echo ' : ' . $la; ?></label> <br>
                                            <?php
                                            if ($lkey == 0) {
