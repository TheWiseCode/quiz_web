    ...
    <div class="d-flex justify-content-center">
        <div class="col-12 col-sm-12 col-md-8 col-lg-8">
            <form method="post" action="<?php echo site_url('user/add_new_group'); ?>">
                ...
                <div class="form-group">
                    <label for="subscription_expired_end" class="font-weight-bold"><?php echo "Fecha Inicio"; ?></label>
                    <input type="date" name="subscription_expired_end" id="subscription_expired_init"
                ...
                <div class="form-group" hidden>
                    <label for="valid_for_days"><?php echo $this->lang->line('valid_for_days'); ?></label>
