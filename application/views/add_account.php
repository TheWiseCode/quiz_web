        ...
        <form method="post" action="<?php echo site_url('account/insert_account/'); ?>">
            <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="name" value="<?php echo $account_name; ?>"
                        ...
                        <div id="result_div">
                            <div class="form-check">
                                <input type="checkbox" value="View" id="result_c0" class="form-check-input"
                                       name="result[]" <?php if (in_array('View', explode(',', $result['result']))) {
                                    echo 'checked';
                                } ?> >
                                <label class="form-check-label" for="quiz_c0">
                                    <?php echo $this->lang->line('view'); ?>
                            ...
                            <div class="form-check">
                                <input type="checkbox" value="List" id="result_c1" class="form-check-input"
                                       name="result[]" <?php if (in_array('List', explode(',', $result['result']))) {
                                    echo 'checked';
                                } ?> >
                            ...
                            <div class="form-check">
                                <input type="checkbox" value="List_all" id="result_c2" class="form-check-input"
                                       name="result[]" <?php if (in_array('List_all', explode(',', $result['result']))) {
                                    echo 'checked';
                                } ?> >
                            ...
                            <div class="form-check">
                                <input type="checkbox" value="Remove" id="result_c3" class="form-check-input"
                                       name="result[]" <?php if (in_array('Remove', explode(',', $result['result']))) {
                                    echo 'checked';
                                } ?> >
