...
// $incorrect+=1;
        ...
        <div class="col-12 col-sm-12 col-md-12 col-lg-12">
            ...
            <div class="card">
                <div class="card-header">
                    <div style="text-align: center;" class="font-weight-bold"><h3 class="font-weight-bold">
                    <span class="text-primary">
                    <?php echo $this->lang->line('hello') . ' ' . $result['first_name'] . ' ' . $result['last_name']; ?>
                    </span>
                    ...
                    <div class="col-lg-12">
                        <div style="text-align: center;">
                            <h2>
                                <span class="text-primary font-weight-bold"><?php echo $result['quiz_name']; ?>   </span>
                            </h2>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <div class="row" style="margin-top:20px;">
                        <div class="col-lg-2" style="text-align:center;">
                            <p class="font-weight-bold"><?php echo $this->lang->line('score_obtained'); ?></p>
                        </div>
                        <div class="col-lg-2" style="text-align:center;">
                            <p class="font-weight-bold"><?php echo $this->lang->line('time_spent'); ?></p>
                        </div>
                        <div class="col-lg-4" style="text-align:center;">
                            <p class="font-weight-bold"><?php echo $this->lang->line('attempt_time'); ?></p>
                        </div>
                        <div class="col-lg-2" style="text-align:center;">
                            <p class="font-weight-bold"><?php echo $this->lang->line('percentage_obtained'); ?></p>
                        </div>
                        <div class="col-lg-2" style="text-align:center;">
                            <p class="font-weight-bold"><?php echo $this->lang->line('percentile_obtained'); ?></p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-2" style="text-align:center;">
                            <p class="text-primary font-weight-bold"><?php echo $result['score_obtained']; ?></p>
                        </div>
                        <div class="col-lg-2" style="text-align:center;">
                            <p class="text-primary font-weight-bold"><?php echo secintomin($result['total_time']); ?>
                                Min.</p>
                        </div>
                        <div class="col-lg-4" style="text-align:center;">
                            <p class="text-primary font-weight-bold"><?php echo date('Y-m-d H:i:s', $result['start_time']); ?></p>
                        </div>
                        <div class="col-lg-2" style="text-align:center;">
                            <p class="text-primary font-weight-bold"><?php echo $result['percentage_obtained']; ?>%</p>
                        </div>
                        <div class="col-lg-2" style="text-align:center;">
                            <p class="text-primary font-weight-bold"><?php echo substr(((($percentile[1] + 1) / $percentile[0]) * 100), 0, 5); ?>
                                %</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                        <div style="text-align: center;">
                            ...
                            if (in_array('List', $acp)) {
                                ?>
                                <a hidden
                                   href="<?php echo site_url('appointment/get_appointment/' . $result['inserted_by']); ?>"
                ...
                <div class="panel-body">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td><?php echo substr(((($percentile[1] + 1) / $percentile[0]) * 100), 0, 2); ?>%</td>
                        </tr>
                        <tr>
    ...
    <div class="row">
        <div class="col-12 col-sm-12 col-md-12 col-lg-12">
            <h3 class="font-weight-bold"><?php echo $this->lang->line('categorywise'); ?></h3>
            <table class="table table-bordered" id="table_categorywise">
                <thead style="color:#ffffff;">
                <tr>
                    <th class="thead-blue"><?php echo $this->lang->line('category_name'); ?></th>
                    <th class="thead-blue"><?php echo $this->lang->line('score_obtained'); ?></th>
                    <th class="thead-blue"><?php echo $this->lang->line('time_spent'); ?></th>
                    <th class="thead-blue"><?php echo $this->lang->line('correct'); ?></th>
                    <th class="thead-blue"><?php echo $this->lang->line('incorrect'); ?></th>
                    <th class="thead-blue"><?php echo $this->lang->line('notattempted'); ?></th>
                </tr>
                </thead>
                <tbody>
                <?php
                ...
                <tr style="background:#337ab7;color:#ffffff;">
                    <th class="thead-blue"><?php echo $this->lang->line('total'); ?></th>
                    <th class="thead-blue"><?php echo $result['score_obtained']; ?></th>
                    <th class="thead-blue"><?php echo secintomin($result['total_time']); ?>
                        Min. <?php echo $this->lang->line('approx'); ?></th>
                    <th class="thead-blue"><?php echo $correct; ?></th>
                    <th class="thead-blue"><?php echo $incorrect; ?></th>
                    <th class="thead-blue"><?php echo $notattempted; ?></th>
                </tr>
                </thead>
            </table>
        </div>
        ...
        <div class="col-12 col-sm-12 col-md-12 col-lg-12">
            ...
            if ($result['show_chart_rank'] == "1") {
                ...
                if ($this->config->item('google_chart') == true) {
                    ?>
                    <!-- google chart starts-->
                    <div id="chart_div" style="width: 100%; height: 500px;" hidden></div>
                    <!-- google chart starts -->
    ...
    <div class="row">
        <div class="col-12 col-sm-12 col-md-12 col-lg-12">
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                ...
                if ($result['view_answer'] == '1' || $logged_in['su'] == '1') {
                    ?>
                    <div class="login-panel panel panel-default noprint mt-3">
                        <div class="panel-body">
                            <a name="answers_i"></a>
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="font-weight-bold"><?php echo $this->lang->line('answer_sheet'); ?></h3>
                                </div>
                                <div class="card-body">
                                    <?php
                                    $abc = [
                                                ...
                                                <div class="row">
                                                    <div class="col-1 col-sm-1 col-md-1 col-lg-1">
                                                        <div class="btn btn-primary rounded-circle"
                                                             style="height: 50px; width: 50px;"><?php echo $qk + 1; ?></div>
                                                    </div>
                                                ...
                                                <div class="row" id="q<?php echo $qk; ?>">
                                                    ...
                                                    <div class="col-10 col-sm-10 col-md-8 col-lg-8">
                                                        ...
                                                        if ($question['question_type'] == ('multiple_choice_single_answer')) {
                                                            ...
                                                            if (!$b) {
                                                                echo "<h5><b>" . $this->lang->line('not_answered') . " </b></h5>";
                                                            }
                                                            echo "<br>";
                                                            echo "<div hidden><b>" . $this->lang->line('correct_options') . '</b>: ' . implode(', ', array_map('trim', ($correct_options))) . "</div>";
                                                        }
                                                        ...
                                                        if ($question['question_type'] == ('multiple_choice_multiple_answer')) {
                                                            ...
                                                            foreach ($options as $ok => $option) {
                                                                if ($option['qid'] == $question['qid']) {
                                                                    ...
                                                                    if (in_array($option['oid'], $save_ans)) {
                                                                        array_push($optionsSaved, trim($option['q_option']));
                                                                    }
                                                                    $i += 1;
                                                                } else {
                                                                    $i = 0;
                                                            ...
                                                            if (!empty($optionsSaved)) {
                                                                echo '<b>' . $this->lang->line('your_answer') . '</b>: ' . implode($optionsSaved, ', ');
                                                            } else {
                                                                echo "<h5><b>" . $this->lang->line('not_answered') . " </b></h5>";
                                                            }
                                                            echo "<br>";
                                                            echo "<div hidden><b>" . $this->lang->line('correct_options') . '</b>: ' . implode(', ', $correct_options) . "</div>";
                                                        }
                                                        ...
                                                        if ($question['question_type'] == ('short_answer')) {
                                                            ...
                                                            if ($save_ans) {
                                                                ...
                                                                ?>
                                                                <h5>
                                                                    <b><?php echo $this->lang->line('not_answered'); ?> </b>
                                                                </h5>
                                                                <?php
                                                            }
                                                            ?>
                                                            ...
                                                            foreach ($options as $ok => $option) {
                                                                if ($option['qid'] == $question['qid']) {
                                                                    echo "<div hidden><b>" . $this->lang->line('correct_answer') . '</b>: ' . $option['q_option'] . "</div>";
                                                                }
                                                            }
                                                            ...
                                                            <div class="op">
                                                                <table>
                                                                    <tr>
                                                                        ...
                                                                        <td hidden><?php echo "<b>" . $this->lang->line('correct_answer') . '</b> '; ?></td>
                                                                    </tr>
                                                                    <?php
                                                                    ...
                                                                    foreach ($match_1 as $mk1 => $mval) {
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                ...
                                                                                if (!$b) {
                                                                                    echo "<div class='text-danger'>No seleccionada</div>";
                                                                                }
                                                                                ?>
                                                                            </td>
                                                                            <td hidden>
                                ...
                                <div class="card-footer">
                                    <div class="row">
                                                ...
                                                <nav aria-label="">
                                                    <ul class="pagination pagination-sm" id="pagination">
                                                        ...
                                                        foreach ($questions as $qk => $question) {
                                                            ?>
                                                            <li class="page-item">
                                                                <a class="page-link"><?php echo $qk + 1; ?></a>
                                                            </li>
                                                            <?php
                                                        }
                                                        ?>
                                        ...
                                        <div class="col-12 col-sm-12 col-md-2 col-lg-2">
                                            <a href="javascript:shoq('-1');" style="width: 100%;"
                                               class="btn btn-primary"><?php echo $this->lang->line('all'); ?></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                // view answer ends
                ?>
                <div class="login-panel panel panel-default onlyprint mt-3">
                    <div class="panel-body">
                        <div>
                            <h3 class="font-weight-bold"><?php echo $this->lang->line('answer_sheet'); ?></h3>
                        </div>
                                    ...
                                    <div class="col-10 col-sm-10 col-md-8 col-lg-8">
                                        ...
                                        if ($question['question_type'] == ('short_answer')) {
                                            ...
                                            if ($save_ans) {
                                                ?>
                                                <div class="op">
                                                    <?php echo '<b>' . $this->lang->line('your_answer') . '</b>: ' . $save_ans; ?>
                                                </div>
                                                <?php
                                            } else {
                                                ?>
