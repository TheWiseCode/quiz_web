                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <div style="display:none;" id="uperror">
                                        Go to 'My_Savsoft_Quiz_Folder*/editor/plugins/jbimages/' Open config.php. at
                                        ...
                                        installed/uploaded savsoft quiz files. if its done in root folder of domain then
