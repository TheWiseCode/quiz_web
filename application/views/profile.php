        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?php
                    if ($qv['question_type'] == ('multiple_choice_single_answer') || $qv['question_type'] == ('multiple_choice_multiple_answer')) {
                    ...
                    if ($qv['question_type'] == ('match_the_column')) {
                        foreach ($options as $ok => $option) {
                            if ($option['qid'] == $qv['qid']) {
                    ...
                    if ($qv['question_type'] == ('short_answer')) {
                        foreach ($options as $ok => $option) {
                            if ($option['qid'] == $qv['qid']) {
                                ?>
                                <div class="alert alert-success"> <?php echo $option['q_option']; ?></div>
                    ...
                    if ($qv['question_type'] == ('long_answer')) {
