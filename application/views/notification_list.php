<div class="container">
            ...
            <table class="table table-bordered">
                ...
                foreach ($result as $key => $val) {
                    ...
                    <tr>
                        ...
                        <td><a href="<?php echo $val['click_action']; ?>"
                               target="fcmclick"><?php echo $val['title']; ?></a></td>
                        ...
                        if ($logged_in['su'] == '1') {
                            ...
                            <td><?php
                                if ($val['uid'] == 0) {
                                    ...
                                    ?><a
                                    href="<?php echo site_url('user/edit_user/' . $val['uid']); ?>"><?php echo $val['first_name'] . ' ' . $val['last_name']; ?></a>
                                    <?php
                                }
                                ?>
    ...
    <a href="<?php echo site_url('notification/index/' . $back); ?>"
