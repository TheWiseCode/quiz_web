...
<div class="footer_buttons">
    ...
    <button class="btn btn-success" id="backbtn" style="visibility:hidden;" onClick="javascript:show_back_question2();"
            style="margin-top:2px;"><?php echo $this->lang->line('back'); ?></button>

    <button class="btn btn-success" id="nextbtn" onClick="javascript:show_next_question2();"
...
<div id="warning_div"
     style="padding:10px; position:fixed;z-index:1200;display:none;width:98%;border-radius:5px;height:120px; border:1px solid #dddddd;left:4px;top:70px;background:#ffffff;">
    <center><b> <?php echo $this->lang->line('really_Want_to_submit'); ?></b> <br><br>
        <span id="processing"></span>

        <a href="javascript:hidespiner();cancelmove();" class="btn btn-danger"
           style="cursor:pointer;"><?php echo $this->lang->line('cancel'); ?></a> &nbsp; &nbsp; &nbsp; &nbsp;
        <a href="javascript:submit_quiz2();" class="btn btn-info"
...
<div class="" id="loading_spin0"
     style="display:none;position:fixed;width:100%;height:100%;z-index:1000;background:#212121;color:#ffffff;opacity:0.8;text-align:center;top:0px;right:0px;">
</div>
</body>
</html>
