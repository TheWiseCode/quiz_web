<div class="">
    ...
    <div class="d-flex justify-content-center">
        <div class="col-12 col-sm-12 col-md-8 col-lg-8">
            <form method="post" action="<?php echo site_url('profile/update_applicant/' . $uid); ?>"
                        ...
                        <div class="form-group">
                            <div class="picture-container" id="profile">
                                <img src="<?php echo base_url($result['photo']) ?>"
                                     class="img-profile rounded rounded-1 border border-dark float-lg-right float-md-right"
                ...
                <div class="form-group">
                    ...
                    <input type="email" id="inputEmail" name="email" class="form-control"
                           ...
                           placeholder="<?php echo $this->lang->line('email_address'); ?>" required
                           autofocus>
                </div>
                <div class="form-group">
                    <div class="row">
