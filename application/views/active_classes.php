                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            if ($this->config->item('SQLc') == true && ($row['SQLc_session_id'] > 0 || $row['initiated_by'] == $logged_in['uid'])) {
                                                ?>
                                                <a href="<?php echo site_url('liveclass/live_streaming/' . $row['class_id'] . '/' . $row['SQLc_session_id']); ?>"
                                                   class="glyphicon glyphicon-facetime-video btn btn-primary "> Live</a>
                                            ...
                                            if (in_array('All', explode(',', $logged_in['setting']))) {
                                                ...
                                                <a href="<?php echo site_url('liveclass/attempt/' . $row['class_id']); ?>"
                                                   class="btn btn-success">Post Content</a>

                                                <a href="<?php echo site_url('liveclass/close_class/' . $row['class_id']); ?>"
                                                   class="btn btn-danger">Close Class</a>

                                                <?php
                                            } else {
                                                ?>
                                                <a href="<?php echo site_url('liveclass/attempt/' . $row['class_id']); ?>"
                                                   class="btn btn-warning">Attend</a>
