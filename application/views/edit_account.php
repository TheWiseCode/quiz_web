<div class="container">
    ...
    <h3><?php echo $this->lang->line('edit_account_type'); ?></h3>
            ...
            <div class="col-md-8">
                ...
                <div class="login-panel panel panel-default">
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            <label><?php echo $this->lang->line('quiz'); ?></label><br>
                            <label class="checkbox-inline">
                        ...
                        <div class="form-group">
                            <label><?php echo $this->lang->line('questions'); ?></label><br>
                        ...
                        <div class="form-group">
                            <label><?php echo $this->lang->line('study_material'); ?></label><br>
