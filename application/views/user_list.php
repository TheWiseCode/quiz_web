...
<td><?php echo $val['name']; ?> <?php echo $val['last_name']; ?></td>
...
<a href="javascript:remove_entry('user/remove_user/<?php echo $val[
    'uid'
...
<br><br><br><br>
<div class="card">
	<div class="card-heading">Importar Usuarios</div>
...
<?php echo $this->lang->line('upload_excel'); ?>
     ...
     <a href="<?php echo base_url(); ?>sample/ejemplo lista de estudiantes.xls" target="new">descargar</a> <?php echo $this->lang->line(
    'upload_excel_info'
); ?>
