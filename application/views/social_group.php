...
<div class="container">
        ...
        <div class="col-lg-12 col-md-12">
            ...
            <form method="post" id="search" action="<?php echo site_url('social_group'); ?>">
                <div class="col-lg-8 col-md-8">
                    <input type="text" name="search" value="<?php echo $this->input->post('search'); ?>"
            ...
            <div class="col-lg-3 col-md-3">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3>
                            <a href="<?php echo site_url('social_group/view/' . $val['sg_id'] . '/#member'); ?>"><?php echo $val['sg_name']; ?></a>
                        </h3>
                    ...
                    <div class="panel-footer">
                        ...
                        if (!in_array($val['sg_id'], $joined)) { ?>
                            <a href="<?php echo site_url('social_group/join/' . $val['sg_id']); ?>"
                               class="btn btn-primary"><i
                                        class="fa fa-plus"></i> <?php echo $this->lang->line('join'); ?></a>
                        <?php } else if ($val['created_by'] != $logged_in['uid']) {
                            ?>
                            <a href="<?php echo site_url('social_group/unjoin/' . $val['sg_id']); ?>"
                               class="btn btn-defult"> <?php echo $this->lang->line('unjoin'); ?></a>
                        <?php } else {
                            ?>
                        ...
                        if (in_array('Invite', $acp)) {
                            ?>
                            <a href="<?php echo site_url('social_group/view/' . $val['sg_id'] . '/invite'); ?>"
                               class="btn btn-primary"> <?php echo $this->lang->line('invite'); ?></a>
                            <?php
                        }
                        if (in_array('Add_other', $acp)) {
                            ?>
                            <a href="<?php echo site_url('social_group/view/' . $val['sg_id'] . '/adduser'); ?>"
                               class="btn btn-primary"> <?php echo $this->lang->line('add_user'); ?></a>
                    ...
                    <div class="panel-footer">
                        ...
                        if (in_array('Edit', $acp)) {
                            ...
                            if ($val['created_by'] == $logged_in['uid']) { ?>
                                ...
                                <a href="<?php echo site_url('social_group/edit_group/' . $val['sg_id']); ?>"> <img
                        ...
                        if (in_array('Remove', $acp)) {
                            if ($val['created_by'] == $logged_in['uid']) {
                                ...
                                ?>
                                <a href="javascript:remove_entry('social_group/remove_group/<?php echo $val['sg_id']; ?>',
    ...
    <div class="col-lg-12">
        ...
        if ($limit != 0) { ?>
            ...
            <a href="<?php echo site_url('social_group/index/' . $back); ?>"
        ...
        <a href="<?php echo site_url('social_group/index/' . $next); ?>"
