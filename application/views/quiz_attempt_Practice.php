            ...
            <div class="row" style="margin:2px;">
                ...
                if (count($categories) > 1) {
                    ...
                    foreach ($categories as $cat_key => $category) {
                        ?>
                        <a href="javascript:switch_category('cat_<?php echo $cat_key; ?>');" class="btn btn-info"
                           style="cursor:pointer;"><?php echo $category; ?></a>
                            ...
                            if ($question['question_type'] == ('short_answer')) {
                                ...
                                <div class="op">
                                    ...
                                    <input type="text" name="answer[<?php echo $qk; ?>][]"
                                           ...
                                           onBlur="showan(this.value);" onKeyup="showan(this.value);">
                                </div>
                                        ...
                                        foreach ($options as $ok => $option) {
                                            if ($option['qid'] == $question['qid']) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $option['q_option_match']; ?></td>
                                                </tr>
...
<div class="footer_buttons" style="background:#3D4A5D;">
    ...
    <button class="btn btn-success btn-lg" id="activeshow" onClick="javascript:check_answer();"
            style="margin-top:2px;display:none;"><?php echo $this->lang->line('show_answer'); ?></button>
    <button class="btn btn-default btn-lg" id="inactiveshow" onClick=""
            style="margin-top:2px;"><?php echo $this->lang->line('show_answer'); ?></button>


    <button class="btn btn-success" id="nextbtn" onClick="javascript:show_next_question();"
            style="margin-top:2px;"><?php echo $this->lang->line('next'); ?></button>
