...
<br> 
       ...
       echo $this->session->flashdata('message');
         ...
         'qbank/pre_question_list/' . $limit . '/' . $cid . '/' . $lid
     ); ?>">
					<select   name="cid">
...
<tr>
 <td>  <a href="javascript:show_question_stat('<?php echo $val[
     'qid'
 ]; ?>');">+</a>  <?php echo $val['qid']; ?></td>
 ...
 <table class="table table-bordered">
<tr><td><?php echo $this->lang->line(
    'no_times_corrected'
); ?></td><td><?php echo $val['no_time_corrected']; ?></td></tr>
<tr><td><?php echo $this->lang->line(
    'no_times_incorrected'
); ?></td><td><?php echo $val['no_time_incorrected']; ?></td></tr>
<tr><td><?php echo $this->lang->line(
    'no_times_unattempted'
); ?></td><td><?php echo $val['no_time_unattempted']; ?></td></tr>
...
<td><?php echo $val[
    'category_name'
]; ?> / <span style="font-size:12px;"><?php echo $val[
     'level_name'
 ]; ?></span></td>
...
<div style="background:#eeeeee;width:100%;height:10px;"><div style="background:#449d44;width:<?php echo intval(
    $perc
); ?>%;height:10px;"></div>
...
$qn = 1;
if (
    $val['question_type'] == $this->lang->line('multiple_choice_single_answer')
) {
    $qn = 1;
}
if (
    $val['question_type'] ==
    $this->lang->line('multiple_choice_multiple_answer')
) {
    $qn = 2;
}
...
<a href="<?php echo site_url(
    'qbank/edit_question_' . $qn . '/' . $val['qid']
); ?>"><img src="<?php echo base_url('images/edit.png'); ?>"></a>
<a href="javascript:remove_entry('qbank/remove_question/<?php echo $val[
    'qid'
...
<?php echo form_open('qbank/import', ['enctype' => 'multipart/form-data']); ?>
...
<a href="<?php echo base_url(); ?>sample/sample.xls" target="new">Click here</a> <?php echo $this->lang->line(
    'upload_excel_info'
); ?> 
</form>
...
<?php echo form_open('word_import', ['enctype' => 'multipart/form-data']); ?>
 
<div class="alert alert-warning"> <?php echo $this->lang->line(
    'wordimportinfo'
); ?></div>
...
<?php echo $this->lang->line('upload_doc'); ?>
	...
	<p style="padding:10px;"><a href="javascript:advanceconfig();"><?php echo $this->lang->line(
     'advance_options'
 ); ?></a></p>
...
<a href="<?php echo base_url(); ?>sample/sample.docx" target="new">Click here</a> <?php echo $this->lang->line(
    'upload_doc_info'
); ?> 
</form>
