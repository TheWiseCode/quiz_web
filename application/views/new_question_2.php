                    ...
                    <div class="panel-body">
                        ...
                        if ($para == 1) {
                            foreach ($lang as $lkey => $val) {
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <label for="inputEmail" class="font-weight-bold"><?php echo $this->lang->line('paragraph') . ' : ' . $val; ?></label>
                        ...
                        foreach ($lang as $lkey => $val) {
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label for="inputEmail" class="font-weight-bold"><?php echo $this->lang->line('question') . ' : ' . $val; ?></label>
                        ...
                        foreach ($lang as $lkey => $val) {
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label for="inputEmail" class="font-weight-bold"><?php echo $this->lang->line('description') . ' : ' . $val; ?></label>
                            ...
                            <div class="row">
                                ...
                                foreach ($lang as $lkey => $val) {
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="form-group">
                                            <label for="inputEmail" class="font-weight-bold"><?php echo $this->lang->line('options'); ?> <?php echo $i; ?>
